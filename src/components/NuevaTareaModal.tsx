...
export default function NuevaTareaModal({ onClose, onCrear }: NuevaTareaModalProps) {
  ...
  const [diasRestantes, setDiasRestantes] = useState<number>(1);
  ...
  return (
    <div className="nueva-tarea-overlay" onClick={onClose}>
      <div className="nueva-tarea-content" onClick={(e) => e.stopPropagation()}>
        {/* Header */}
        <div className="nueva-tarea-header">
          <h2 className="nueva-tarea-titulo">Nueva Tarea</h2>
        ...
        {/* Body */}
        <div className="nueva-tarea-body">
          {/* Título */}
        ...
        {/* Footer */}
        <div className="nueva-tarea-footer">
          <button className="btn-cancelar" onClick={onClose}>
            Cancelar
          </button>
          <button className="btn-crear-tarea" onClick={handleCrear}>
            Crear Tarea
          </button>
        </div>
      </div>

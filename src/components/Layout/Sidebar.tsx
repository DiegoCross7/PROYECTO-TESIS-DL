...
type Vista = 'inicio' | 'usuarios' | 'proyectos' | 'configuraciones';
 ...
 * Componente: Sidebar
 * 
 * Descripción: Menú lateral de navegación
 * Responsabilidad: Navegación entre secciones
 */
export default function Sidebar({ vistaActual, onNavigate }: SidebarProps) {
  const menuItems = [
    {
      id: 'inicio' as Vista,
      label: 'Inicio',
